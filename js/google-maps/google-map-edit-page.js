(function($) {
	...
	{
		parentConstructor.prototype.onRightClickMap.call(this, event);
	...
	WPGMZA.GoogleMapEditPage.prototype.editMarker = function(marker)
	{
		...
		parentConstructor.prototype.editMarker.call(this, marker);
	}
	
	WPGMZA.GoogleMapEditPage.prototype.onPolygonAdded = function(event)
	{
		parentConstructor.prototype.onPolygonAdded.call(this, event);
	...
	{
		parentConstructor.prototype.onPolylineAdded.call(this, event);
	...
	{
		parentConstructor.prototype.onPolylineRemoved.call(this, event);
