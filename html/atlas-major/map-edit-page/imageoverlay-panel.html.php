<div class="wpgmza-feature-panel">
	...
	<div class="wpgmza-feature-editing-instructions">
		<div class="am-ph-title"><?php _e("Edit Image Overlay", "wp-google-maps"); ?></div>
		<div class="wpgmza-card wpgmza-shadow wpgmza-instruction-card wpgmza-pro-feature wpgmza-pro-feature-hide">
	...
	<div class="wpgmza-upsell wpgmza-card wpgmza-shadow">
		<?php
			echo sprintf(
				...
				esc_attr("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&utm_medium=link&utm_campaign=imageoverlayseditor-atlas-major-v10" . wpgmzaGetUpsellLinkParams())
			);
		?>
		<a target="_BLANK" class="wpgmza-upsell-button"
			href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=imvageoverlayseditor-btn-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
