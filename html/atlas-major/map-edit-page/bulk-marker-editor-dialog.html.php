			...
			<div class="wpgmza-upsell">
				<?php
					echo sprintf(
						...
						esc_attr("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&utm_medium=link&utm_campaign=bulkedit-atlas-major-v10" . wpgmzaGetUpsellLinkParams())
					);
				?>
			</div>
