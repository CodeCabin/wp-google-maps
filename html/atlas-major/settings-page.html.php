<form 
	...
	class="wpgmza-atlas-major wpgmza-form wpgmza-tabs-container wpgmza-wrap"
	action="<?php 
	...
	<div id="general-settings">
		...
		<div class="tab-row has-hint" data-required-maps-engine="google-maps">
			...
			<input name="wpgmza_google_maps_api_key" id='wpgmza_google_maps_api_key' type='text' style='width: 40%;' />
		</div>
		...
		<div class="tab-row has-hint" data-required-maps-engine="leaflet-azure">
			...
			<input name="wpgmza_leaflet_azure_key" id='wpgmza_leaflet_azure_key' type='text' style='width: 40%;' />
		</div>
		...
		<div class="tab-row has-hint" data-required-maps-engine="leaflet-stadia">
			...
			<input name="wpgmza_leaflet_stadia_key" id='wpgmza_leaflet_stadia_key' type='text' style='width: 40%;' />
		</div>
		...
		<div class="tab-row has-hint" data-required-maps-engine="leaflet-maptiler">
			...
			<input name="wpgmza_leaflet_maptiler_key" id='wpgmza_leaflet_maptiler_key' type='text' style='width: 40%;' />
		</div>
		...
		<div class="tab-row has-hint" data-required-maps-engine="leaflet-locationiq">
			...
			<input name="wpgmza_leaflet_locationiq_key" id='wpgmza_leaflet_locationiq_key' type='text' style='width: 40%;' />
		</div>
		...
		<div class="tab-row" data-required-maps-engine="google-maps">
			...
			<small class="hint">
				...
				the <a href='https://wpgmaps.com/google-maps-developer-console/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-dev-console-atlas-major-v10' target='_BLANK'>Google Developers Console</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-a-google-maps-api-key/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-create-api-key-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
		</div>
		...
		<div class="tab-row" data-required-maps-engine="leaflet-azure">
			...
			<small class="hint">
				...
				the <a href='https://portal.azure.com/' target='_BLANK'>Azure Portal</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-an-azure-maps-subscription-key/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-azure-key-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
		</div>
		...
		<div class="tab-row" data-required-maps-engine="leaflet-stadia">
			...
			<small class="hint">
				<?php
				_e("This key can be obtained from 
				<a href='https://client.stadiamaps.com' target='_BLANK'>Stadia Maps</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-a-stadia-maps-api-key/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-stadia-key-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
		</div>
		...
		<div class="tab-row" data-required-maps-engine="leaflet-maptiler">
			...
			<small class="hint">
				<?php
				_e("This key can be obtained from 
				<a href='https://cloud.maptiler.com/' target='_BLANK'>Maptiler</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-a-maptiler-api-key/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-maptiler-key-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
		</div>
		...
		<div class="tab-row" data-required-maps-engine="leaflet-locationiq">
			...
			<small class="hint">
				<?php
				_e("This key can be obtained from 
				<a href='https://locationiq.com/' target='_BLANK'>LocationIQ</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-a-location-iq-access-token/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-locationiq-key-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
		</div>
		...
		<div class="tab-row wpgmza-hidden">
			<div class="title">
				...
				(<em><a href='https://www.wpgmaps.com/help/docs/user-interface-style-legacy/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-interface-style-docs-atlas-major-v10' target='_BLANK'><?php esc_html_e('examples', 'wp-google-maps'); ?></a></em>)
			</div>
	...
	<div id="info-windows">
		...
		<div class="wpgmza-upsell wpgmza-card wpgmza-shadow">
			<a target="_BLANK"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=iw_style_settings-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
			...
			<a target="_BLANK" class="wpgmza-upsell-button"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=iw_style_settings_btn-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
			...
			<ul>
				...
				<li>
					<div class='switch switch-inline'>
						...
						<label for='wpgmza_settings_infowindow_links'>
			...
			<ul>
				...
				<li>
					<div class='switch switch-inline'>
						...
						<label for='wpgmza_settings_infowindow_links_nofollow'>
				...
				<li>
					<div class='switch switch-inline'>
						...
						<label for='wpgmza_settings_infowindow_links_noopener'>
				...
				<li>
					<div class='switch switch-inline'>
						...
						<label for='wpgmza_settings_infowindow_links_noreferrer'>
							<?php esc_html_e("Mark as no opener","wp-google-maps"); ?>
							<small>
	...
	<div id="marker-listing">
		...
		<div class="wpgmza-upsell wpgmza-card wpgmza-shadow">
			<a target="_BLANK"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=mlisting_settings-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
			...
			<a target="_BLANK" class='wpgmza-upsell-button' 
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=mlisting_settings_btn-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
		...
		<!-- Use image placeholders (Atlas Major general rule).
		     Bound to `image_placeholder_enabled` in wpgmza_global_settings
		     (defaults ON for fresh installs). General toggle — applies to
		     both marker listings and info windows, and can be overridden
		     per map in the map editor. -->
		<div class="tab-row wpgmza-pro-feature">
			<div class="title"><?php esc_html_e("Image Placeholders","wp-google-maps"); ?></div>

			<div class="switch switch-inline">
				<input name="image_placeholder_enabled"
						id="image_placeholder_enabled"
						class="cmn-toggle cmn-toggle-round-flat"
						type="checkbox"/>

				<label for="image_placeholder_enabled"></label>
				<label for="image_placeholder_enabled">
					<small>
						<?php esc_html_e('Use image placeholders where no image exists for a marker. Applies to marker listings and info windows. Can be overridden per map in the map editor.', 'wp-google-maps'); ?>
					</small>
				</label>
			</div>
		</div>
	...
	<div id="categories">
		...
		<div class="wpgmza-upsell wpgmza-card wpgmza-shadow">
			<a target="_BLANK"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=categories_settings-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
				<?php _e('Categorize markers', 'wp-google-maps'); ?> 
			</a> <?php _e('with the Pro version. Support and updates included forever.', 'wp-google-maps'); ?>

			<a target="_BLANK" class="wpgmza-upsell-button"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=categories_settings_btn-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
	...
	<div id="gdpr-compliance">
		...
		<div class="gdpr-usage-notice">
			...
			<p>
				<?php
				_e('For more information about WPGM and GDPR compliance, please refer to our <a href="https://www.wpgmaps.com/gdpr/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-gdpr-atlas-major-v10">GDPR information page</a> and our <a href="https://www.wpgmaps.com/privacy-policy/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-gdpr-privacy-atlas-major-v10">Privacy Policy</a>', 'wp-google-maps');
				?>
			</p>
		</div>
		...
		<div id="wpgmza-gdpr-compliance-notice" style="display: none;">
			...
			<div class="tab-row">
				...
				<input name="wpgmza_gdpr_company_name" type='text'/>
			</div>
			...
			<div class="tab-row has-hint">
				...
				<input name="wpgmza_gdpr_retention_purpose" type='text'/>
				<div class="inline-hint">
			...
			<div class="tab-row has-hint">
				...
				<input name="wpgmza_gdpr_button_label" type='text'/>
				<div class="inline-hint">
	...
	<div id="advanced-settings">
		...
		<div class="tab-row">
			...
			<small class="inline-hint">
				<a href="https://www.wpgmaps.com/help/docs/address-providers/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-address-provider-docs-atlas-major-v10" target="_blank"><?php _e("Learn about address providers", "wp-google-maps"); ?></a>
			</small>
		</div>
		...
		<div data-required-address-provider="google-maps|azure-maps|location-iq" class="tab-row">
			...
			<small class="hint" data-required-address-provider="google-maps">
				<?php
				_e("This API key can be obtained from 
				the <a href='https://wpgmaps.com/google-maps-developer-console/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-dev-console-addr-atlas-major-v10' target='_BLANK'>Google Developers Console</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-a-google-maps-api-key/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-create-api-key-addr-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
			...
			<small class="hint" data-required-address-provider="azure-maps">
				<?php
				_e("This key can be obtained from 
				the <a href='https://portal.azure.com/' target='_BLANK'>Azure Portal</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-an-azure-maps-subscription-key/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-azure-key-addr-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
			...
			<small class="hint" data-required-address-provider="location-iq">
				<?php
				_e("This key can be obtained from 
				<a href='https://locationiq.com/' target='_BLANK'>LocationIQ</a>. Our <a href='https://www.wpgmaps.com/help/docs/creating-a-location-iq-access-token/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-locationiq-key-addr-docs-atlas-major-v10' target='_BLANK'>documentation</a> provides a full guide on how to obtain this.", "wp-google-maps");
				?>
			</small>
		</div>
		...
		<div class="tab-row">
			...
			<input name="wpgmza_always_include_engine_api_on_pages" type='text' placeholder="<?php _e('Page IDs'); ?>"/>
		</div>
		
		<!-- Exclude API -->
		<div class="tab-row">
			<div class="title"><?php _e('Always exclude engine API on pages', 'wp-google-maps'); ?></div>
			<input name="wpgmza_always_exclude_engine_api_on_pages" type='text' placeholder="<?php _e('Page IDs'); ?>"/>
		</div>
	...
	<div id="integrations">
		...
		<div class="wpgmza-upsell wpgmza-card wpgmza-shadow">
			<a target="_BLANK"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=acf_settings-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
				<?php _e('Advanced Custom Fields Integration', 'wp-google-maps'); ?> 
			</a> <?php _e('with the Pro version. Support and updates included forever.', 'wp-google-maps'); ?>

			<a target="_BLANK" class="wpgmza-upsell-button"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=acf_settings_btn-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
		...
		<div class="wpgmza-upsell wpgmza-card wpgmza-shadow">
			<a target="_BLANK"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=woo_settings-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
				<?php _e('WooCommerce Integration', 'wp-google-maps'); ?> 
			</a> <?php _e('with the Pro version. Support and updates included forever.', 'wp-google-maps'); ?>

			<a target="_BLANK" class="wpgmza-upsell-button"
				href="<?php echo esc_attr(\WPGMZA\Plugin::getProLink("https://www.wpgmaps.com/purchase-professional-version/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=woo_settings_btn-atlas-major-v10" . wpgmzaGetUpsellLinkParams()));  ?>">
	...
	<div id="custom-scripts">
		...
		<div class="tab-row">
			...
			<div class="wpgmza-card wpgmza-shadow notice" style='margin-left: 0;'>
				<span><?php _e("Take a look at our <a href='https://www.wpgmaps.com/help/docs/customization-guides/?utm_source=plugin&amp;utm_medium=link&amp;utm_campaign=settings-customization-docs-atlas-major-v10' target='_BLANK'>customization guides</a> for starter presets!"); ?></span>
			</div>
		</div>
	...
	<div id='danger-zone'>
		...
		<div class="tab-row">
			...
			<?php
			/* Render the selected state server-side. The form-wide
			   DOMDocument populate() in SettingsPage normally adds
			   selected="selected" to the matching option, but it
			   has been observed to intermittently miss this select
			   (notably after a Complete Reset → first visit to this
			   page), leaving Atlas Novus showing even when the
			   effective engine is Atlas Major. Emitting `selected()`
			   here guarantees the rendered HTML reflects the
			   real engine regardless of populate's outcome.
			   `autocomplete="off"` blocks browser form-state
			   restoration from overriding the server-rendered
			   selection on bfcache restores.
			   Source of truth is `internalEngine->getStoredEngine()`,
			   not `settings->internal_engine` directly — the raw
			   setting can be null right after a fresh install /
			   Complete Reset before defaults propagate, whereas
			   InternalEngine::validateEngine() always returns a
			   valid value (falls back to the stable build name,
			   currently Atlas Major). This matches what the rest
			   of the system loaded as the engine for the request. */
			global $wpgmza;
			$wpgmzaInternalEngineSelected = '';
			if(!empty($wpgmza) && !empty($wpgmza->internalEngine) && method_exists($wpgmza->internalEngine, 'getStoredEngine')){
				$wpgmzaInternalEngineSelected = $wpgmza->internalEngine->getStoredEngine();
			} else if(!empty($wpgmza) && !empty($wpgmza->settings) && !empty($wpgmza->settings->internal_engine)){
				/* Older Basic without getStoredEngine — fall back to raw setting. */
				$wpgmzaInternalEngineSelected = $wpgmza->settings->internal_engine;
			}
			?>
			<select name="internal_engine" id="internal_engine" autocomplete="off">
				<option value="atlas-novus" <?php selected($wpgmzaInternalEngineSelected, 'atlas-novus'); ?>><?php esc_html_e('Atlas Novus', 'wp-google-maps'); ?></option>
				<option value="atlas-major" <?php selected($wpgmzaInternalEngineSelected, 'atlas-major'); ?>><?php esc_html_e('Atlas Major (Beta)', 'wp-google-maps'); ?></option>
				<option value="legacy" <?php selected($wpgmzaInternalEngineSelected, 'legacy'); ?>><?php esc_html_e('Legacy', 'wp-google-maps'); ?></option>
			</select>
		</div>
