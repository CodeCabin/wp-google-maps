					...
					<fieldset>
						...
						<small class='wpgmza-info__small'>
							<i>
								...
								echo ". ".sprintf(__("Or <a href='%s' target='BLANK'>click here to automatically create a Map Page now</a>.", "wp-google-maps"), "admin.php?page=wp-google-maps-menu&amp;action=create-map-page&amp;map_id=".(!empty($_REQUEST['map_id']) ? intval($_REQUEST['map_id']) : '' ));
