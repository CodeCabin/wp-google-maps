<div class="wrap about-wrap" style="padding-top: 1em;">
	<h1>
		<?php 
	...
	<div class="about-text"><?php _e("Thank you for updating! WP Google Maps helps you build amazing maps through a simple interface and powerful functionality along with world class support.","wp-google-maps"); ?></div>
...
Nick Duncan</a>
	...
	<li class="wp-person" id="wp-person-perryrylance">
		<a href="https://profiles.wordpress.org/perryrylance/" class="web">
			<img src="https://secure.gravatar.com/avatar/9761763c79d8b3dbf5b2981b332156de?s=150&amp;d=mm&amp;r=g" class="gravatar"/>
			Perry Rylance
		</a>
		<span class="title"><?php _e("Lead Developer", "wp-google-maps"); ?></span>
	</li>
