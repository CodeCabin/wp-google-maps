...
<div class="wpgmza_row">
	...
	<div class='wpgmza_row_col' style='background-color:#FFF;padding: 12px;'>
		...
		<ul>
			...
			<li><a href='https://www.wpgmaps.com/documentation/troubleshooting/im-getting-jquery-errors-showing-on-my-website/' target='_BLANK'><?php _e("I'm getting jQuery errors showing on my website","wp-google-maps"); ?></a></li>
		</ul>
	</div>
	<div class='wpgmza_row_col' style='background-color:#FFF;padding: 12px;'>
