        ...
        echo "
           ...
           <div class='wrap'>
                ...
                <div class='wide'>
                    ...
                    <p class='submit'><a href='javascript:history.back();' class='button button-secondary' title='".__("Cancel", "wp-google-maps")."'>".__("Cancel", "wp-google-maps")."</a> <input type='submit' name='wpgmza_save_rectangle' class='button-primary' value='".__("Save rectangle","wp-google-maps")." &raquo;' /></p>
...
function wpgmza_b_edit_rectangle($mid)
{
    ...
    if ($_GET['action'] == "edit_rectangle" && isset($mid)) {
		...
		if(empty($results))
		{
			echo "<p class='notice notice-error'>" . esc_html__('Invalid rectangle ID', 'wp-google-maps') . "</p>";
			return;
		}
